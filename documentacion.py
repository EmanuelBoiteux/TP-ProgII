...
def palabrasAntePos(palabra: str, listaPalabras: list, n: int) -> dict:
    ...
    - si n = -1 devuelve un diccionario cuyas claves son las palabras de la lista que se encuentran en una posicion i + 1 respecto a las ocurrencias en la lista
    de la palabra pasada, siendo i su indice.
    En cualquier caso los valores del diccionario son lasa ocurrencias de cada palabra. Si la palabra pasada no tiene palabras anteriores o posteriores se devuelve {}.
    """
    pass
...
def remplazaGuion(anterior: str, siguiente: str, palabrasDict: dict[dict], linea: str, masFrecuente: str, archivoSalida):
    ...
    la palabra mas frecuente del mismo y un archivo. Se encarga de escribir el archivo pasado como argumento
    un archivo de texto donde los guiones que estan en la linea son remplazados por palabras de acuerdo al siguiente criterio: 
